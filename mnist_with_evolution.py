"""
Train a neural network on mnist with PyTorch. Adapted from Xu Ma's mnist script(https://github.com/13952522076/DNN).
...
--mnist=100         Version of mnist to use. Must be 10 or 100.
...
e.g.
    python3 mnist.py --netName=PreActResNet18 --mnist=10 --bs=512
...
parser = argparse.ArgumentParser(description='PyTorch mnist10 Training')
...
parser.add_argument('--mnist', default=10, type=int, help='dataset classes number')
...
def main():
    ...
    try:
        net = models.__dict__[args.netName](num_classes=args.mnist, dna_string='64 64')
    except:
    ...
    if args.resume:
        ...
        checkpoint_path = './checkpoint/ckpt_mnist_' + str(args.mnist) + '_' + args.netName + '.t7'
    ...
    def train(epoch_number):
        ...
        file_path = './records/mnist/mnist_' + str(
            args.mnist) + '_' + args.netName +  '_train.txt'
    ...
    def test(epoch_number):
        ...
        file_path = './records/mnist/mnist_' + str(args.mnist) + '_' + args.netName + '_test.txt'
        ...
        if acc > best_acc:
            ...
            if not os.path.isdir('checkpoint'):
                os.mkdir('checkpoint')
            save_path = './checkpoint/ckpt_mnist_' + str(args.mnist) + '_' + args.netName  + '.t7'
    ...
    statis_path = './records/mnist/STATS_' + args.netName + '.txt'
