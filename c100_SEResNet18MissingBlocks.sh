#!/bin/bash
#BATCH --job-name=SEResNet18WithOneLayerOfSEBlocks
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 ./cifarWithMissingBlocks.py --netName=SEResNet18WithOneLayerOfSEBlock --bs=512 --cifar=100 --missing=10
